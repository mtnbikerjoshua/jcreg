...
var_selection <- function(data, method = "all", metric = "BIC",
  ...
  best_subsets <- forward <- backward <- seqrep <- lasso <- elastic <- NULL
...
#'
#' This function is identical to stats::summary.glm except the class of the
#' output is changed for more versitile output
#'
#' @export
...
#' Summarizing Generalized Linear Model Fits
#'
#' This function is a slilght modification of stats::print.summary.glm
#'
#' @export
